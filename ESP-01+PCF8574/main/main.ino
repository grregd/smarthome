...
static const char *VERSION = "Version: ESP-01+PCF8574 v. 0.1\n"
                             "Build date: " __DATE__ "\n"
                             "Build time: " __TIME__ "\n";
...
void setupWifi() {
  ...
  parseConfig(
      ...
      [versionInfo](int port, int activeLevel, const String &headerMarker,
                    const String &num, bool logic) {
        handlers.push_back(Handler(std::unique_ptr<Handlers::BoardOutputDevice>(
                                       new Handlers::BoardOutputDevice(port)),
